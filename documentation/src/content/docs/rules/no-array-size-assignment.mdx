...
In roblox-ts, `array[array.size()] = value` is an append pattern that's easy to miss in review and awkward to search
for. This rule reports it and nudges you toward `array.push(value)`.
