...
badge:
    text: Best Practice
    variant: success
description: Prefer function components with typed props over React.FC.
---
...
import { to, safe } from "sury";
import { Convert, Clean, Check } from "typebox/value";
import { types } from "util";
import { variant, includes, is, description } from "valibot";
