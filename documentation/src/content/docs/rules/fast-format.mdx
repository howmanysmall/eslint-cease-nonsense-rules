...
<CardGrid>
	<LinkCard title="no-commented-code" description="Clean up old code blocks" href="/eslint-cease-nonsense-rules/rules/no-commented-code/" />
	<LinkCard title="naming-convention" description="Enforce fast naming standards" href="/eslint-cease-nonsense-rules/rules/naming-convention/" />
</CardGrid>
