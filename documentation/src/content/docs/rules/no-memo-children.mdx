...
- [require-react-display-names](/rules/require-react-display-names/) - Ensures memo components have displayName
- [ban-react-fc](/rules/ban-react-fc/) - Bans problematic React.FC pattern
