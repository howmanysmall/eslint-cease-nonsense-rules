...
- [no-god-components](/rules/no-god-components/) - Reduces component complexity
- [prefer-module-scope-constants](/rules/prefer-module-scope-constants/) - Organizes constants
