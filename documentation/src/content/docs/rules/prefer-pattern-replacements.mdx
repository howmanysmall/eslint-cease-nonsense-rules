...
This rule uses a type-safe pattern matching system to detect verbose constructor or method calls that have simpler
equivalents. It supports captures, optional arguments, wildcards, and scope-aware fixes.
