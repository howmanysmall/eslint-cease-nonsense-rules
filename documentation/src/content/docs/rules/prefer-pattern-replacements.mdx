...
This rule matches constructor or method calls against patterns you define and rewrites them to simpler equivalents. It
supports captures, optional arguments, wildcards, and scope-aware fixes.
