...
badges:
    ...
    - text: "Fixable"
      variant: success
description: Prefer ColorSequence/NumberSequence overloads over manual keypoint arrays.
---
...
Roblox has constructor overloads for `ColorSequence` and `NumberSequence` that cover the common two-keypoint case. This
rule prefers those overloads over manually building arrays of keypoints.

<Aside type="tip" title="Performance">
	The overloads avoid allocating a temporary array and keypoint objects.
</Aside>
