...
Reports constructor chains where `map` is called immediately after `table.create(...)` or `new Array(...)`. In roblox-ts,
this hides fill semantics and makes the code harder to follow.
