...
- [prefer-udim2-shorthand](./prefer-udim2-shorthand.md) - Similar performance rule for UDim2
- [prefer-sequence-overloads](./prefer-sequence-overloads.md) - Optimized sequence constructors
- [prefer-pattern-replacements](./prefer-pattern-replacements.md) - General constructor optimization
