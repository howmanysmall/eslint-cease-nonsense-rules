import { getMemberPropertyName, walkAst } from "@utilities/ast-utilities";
import { isFunctionNode } from "@utilities/oxc-utilities";
...
export function countExpectCalls(
	...
	walkAst(body, function walk(child): void {
