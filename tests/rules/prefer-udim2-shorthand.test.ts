...
describe("prefer-udim2-shorthand", () => {
	...
	ruleTester.run("prefer-udim2-shorthand", rule, {
		...
		valid: [
			...
			"new UDim2(!1, 1, !2, 1);",
			"new UDim2(!1, 0, !2, 0);",
			"new UDim2(+foo(), 0, +bar(), 0);",
			"new UDim2(-foo(), 0, -bar(), 0);",
			"new UDim2(0, +foo(), 0, +bar());",
			"new UDim2(foo(), 0, bar(), 0);",
			"new UDim2(1 + foo(), 0, 2 + bar(), 0);",
			"new UDim2(foo() + 1, 0, bar() + 2, 0);",
			"new UDim2(1 & 2, 0, 3 & 4, 0);",
			"new UDim2(1, 1 / 0, 0, 2 / 0);",
			"new UDim2(1, 1 % 0, 0, 2 % 0);",
			"new UDim2(1, +offset, 0, +otherOffset);",
			"new UDim2(...values, 0, 0, 0);",
