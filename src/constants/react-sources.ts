...
export function getReactSources(environment: EnvironmentMode): Set<string> {
	return environment === "roblox-ts" ? REACT_SOURCES_ROBLOX : REACT_SOURCES_STANDARD;
}

export function isReactImport(node: TSESTree.ImportDeclaration, reactSources: Set<string>): boolean {
